		...
		<>
			<div className="explore-container">
				<div className="explore-heading-container">
					<h1 className="explore-main-heading margin-bottom">
						Explore
					</h1>
					<div className="explore-search-container">
						<input
							...
							placeholder="Search Projects, Programs and Coops"
						/>
						<img
						...
						<div className="explore-section-container">
							...
							<div className="explore-content-container">
								...
								<div className="explore-widget-container">
									<h1 className="explore-widget-main-heading">
										Project Name
									</h1>
									<h2 className="explore-widget-sub-heading">
										Community Name
									</h2>
									<h3 className="explore-widget-sub-heading margin-bottom">
										Progress: 100%
									</h3>
									<p className="explore-widget-sub-text margin-bottom">
										This is a placeholder description for
										widgets displaying on the website. It
										should cut off after a while.
									</p>
									<button
										className="explore-widget-view-button"
										onClick={() =>
								...
								<div className="explore-widget-container">
									...
									<button className="explore-widget-view-button">
										View
									</button>
								</div>
								<button className="explore-widget-nav-button">
