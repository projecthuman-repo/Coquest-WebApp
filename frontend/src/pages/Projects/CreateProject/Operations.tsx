...
const Operations: React.FC = () => {
	...
	const [ownSpace, setOwnSpace] = useState<boolean | undefined>(
		project.admin.ownSpace,
	);
	const [bookedRentalSpace, setBookedRentalSpace] = useState<
		boolean | undefined
	>(project.admin.bookedRentalSpace);
	const [additionalInfo, setAdditionalInfo] = useState<string>(
		project.admin.additionalInfo,
	);
	...
	const updateProjectOperations = () => {
		...
		let canProceed =
			...
			updatedProject.admin.ownSpace !== undefined;
		if (updatedProject.admin.ownSpace === false) {
			canProceed =
				canProceed &&
				updatedProject.admin.bookedRentalSpace !== undefined;
		}
