    ...
    if(user) {
        return (
            ...
            <div className="create-community-page">
                ...
                <h2 className="sub-heading">Let's create a new community! Enter the information below to get started.</h2>
                    <form className="form-container" onSubmit={onSubmit}>
                        <div className="form-background">
                            {/* Community Name*/}
                            <label className="sub-text" htmlFor="name">Name</label>
                            <input id="name" name="name" className="name-input" type="text" value={community.name!} onChange={e => handleInputChange(e.target.name, e.target.value)} />
                            {/* Community Description*/}
                            <label className="sub-text" htmlFor="description">Description</label>
                            <textarea id="description" className="description-input" name="description" value={community.description!} onChange={e => handleInputChange(e.target.name, e.target.value)} />
                        </div>
                        <div className="form-background">
                            {/* Community Tags*/}
                    ...
                    <div className="form-background">
                        ...
                        <Location headingText="false"user={user} updateData={(location: any) => handleInputChange('location', location)} />
                    </div>
                    <div className="form-background">
                    ...
                    <div className="button-container">
                        <button className="submit-button" type="submit" form="community-form" disabled={formError !== null}>Submit</button>
                    </div>
                    {formError !== null && (
