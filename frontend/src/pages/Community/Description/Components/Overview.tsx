      ...
      <div className="com-o-flex-widget-container">
        <div className="com-o-left">
          ...
          <div className="com-o-background">
            ...
            <h2 className="com-o-sub-heading margin-bottom">Objective</h2>
            <p className="com-o-sub-text margin-bottom">N/A</p>
            <h2 className="com-o-sub-heading margin-bottom">Initiative</h2>
            <p className="com-o-sub-text margin-bottom">N/A</p>
          </div>
          {/* Members */}
          <div className="com-o-background">
          <h2 className="com-o-sub-heading margin-bottom">Members</h2>
            <Members
              users={
        ...
        <div className="com-o-right">
          {/* Calendar */}
          <div className="com-o-background">
            <h2 className="com-o-sub-heading margin-bottom">Calendar</h2>
            <Calendar />
          </div>
          {/* Quests */}
          <div className="com-o-background">
