	...
	return (
		<>
			<button
				...
				onClick={() => navigate(window.location.pathname.replace(/\/quests$/, ''))}
			>
				...
				<div className="quests-nav-button-container">
					...
					<button
						className={`quests-nav-button-design ${
							section === "ongoing" ? "quests-nav-button-selected" : ""
						}`}
					...
					<button
						className={`quests-nav-button-design ${
							section === "completed" ? "quests-nav-button-selected" : ""
						}`}
				...
				<div className="quests-container margin-top">
					<div className="quests-widget">
						...
						<h2 className="quests-widget-heading-small">Project Name</h2>
						<h2 className="quests-widget-heading-small">Location Name</h2>
						<p className="margin-top">Description</p>
						<div className="quests-widget-expand margin-top">
							<button>
								<img src="/icons/expand-button-chevron.png" alt="expand-icon" />
							</button>
						</div>
					</div>
					<div className="quests-widget">
