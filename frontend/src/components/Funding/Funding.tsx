...
function Funding() {
	...
	return (
        ...
        <div className="funding-group-container margin-top">
            <h2 className="funding-text">You are at 0% of your crowdfunding goal.</h2>
            <a href="/" className="funding-link">Edit Goal</a>
        </div>
        ...
        <div className="funding-group-container margin-top">
            ...
            <a href="/" className="funding-link">View All</a>
        </div>
        <div className="funding-backer-container">
			<p className="funding-text"><b>Name</b></p>
            <p><b>Amount</b></p>
		</div>
        <div className="funding-backer-container">
